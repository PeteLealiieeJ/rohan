...
with open( os.path.join("EOS_Tracking","version.txt") ) as file:
...
Repository:
https://github.com/PeteLealiieeJ/EOS-Tracking
...
setup(
    name="EOS_Tracking",
    packages=[package for package in find_packages() if package.startswith("EOS_Tracking")],
    package_data={"EOS_Tracking": ["version.txt"]},
    install_requires=[
        "numpy", 
    ],
    extras_require={
    ...
    url="https://github.com/PeteLealiieeJ/EOS-Tracking",
    ...
    python_requires=">=3.8",
    project_urls={
        "Code": "https://github.com/PeteLealiieeJ/EOS-Tracking",
    },
    classifiers=[
