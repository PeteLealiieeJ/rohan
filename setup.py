...
with open( os.path.join("rohan","version.txt") ) as file:
...
Repository:
https://github.com/PeteLealiieeJ/rohan
...
setup(
    name="rohan",
    packages=[package for package in find_packages() if package.startswith("rohan")],
    package_data={"rohan": ["version.txt"]},
    install_requires=[
        "numpy", 
    ],
    extras_require={
    ...
    url="https://github.com/PeteLealiieeJ/rohan",
    ...
    python_requires=">=3.8",
    project_urls={
        "Code": "https://github.com/PeteLealiieeJ/rohan",
    },
    classifiers=[
